    ...
    return (
        <>
            ...
            <ul className={styles.bullets}>
                ...
                <li className={styles.sentence + " p"}>In patients unable to take their usual PD medications orally, this tool is designed to convert a patient&apos;s usual PD medications to a &lsquo;Levodopa equivalent dose&rsquo; (LED).</li>
